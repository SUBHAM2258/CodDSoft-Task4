...
# images
rock1_img = PhotoImage(file="rock1.png")
rock2_img = PhotoImage(file="rock2.png")
paper1_img = PhotoImage(file="paper1.png")
paper2_img = PhotoImage(file="paper2.png")

scissor1_img = PhotoImage(file="scissor1.png")
scissor2_img = PhotoImage(file="scissor2.png")
title_img = PhotoImage(file="title.png")

title_frame = Label(image=title_img)
